	...
	fields := []Field{
		{
			...
			Value: os.Getenv("SLACK_DESCRIPTION"),
			Short: false,
		},
		{
			Title: "Message",
			Value: fmt.Sprintf("<%s|%s>",
				"https://github.com/"+os.Getenv("GITHUB_REPOSITORY")+"/commit/"+os.Getenv("GITHUB_SHA"),
				strings.ReplaceAll(strings.ReplaceAll(envOr(EnvSlackMessage, "EOM"), "<", "&lt;"), ">", "&gt;")),
			Short: false,
		},
	}
