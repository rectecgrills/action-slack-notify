This action is adapted from the [GitHub Actions Library](https://github.com/rtCamp/github-actions-library/) created by [rtCamp](https://github.com/rtCamp/).

The following description is out of date and is here only for reference.
